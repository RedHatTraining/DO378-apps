...
insert into Speaker (id, uuid, name) values (nextval('speaker_seq'), 's-1-1', 'Emmanuel');
insert into Speaker (id, uuid, name) values (nextval('speaker_seq'), 's-1-2', 'Clement');
insert into Speaker (id, uuid, name) values (nextval('speaker_seq'), 's-1-3', 'Alex');
insert into Speaker (id, uuid, name) values (nextval('speaker_seq'), 's-1-4', 'Burr');
